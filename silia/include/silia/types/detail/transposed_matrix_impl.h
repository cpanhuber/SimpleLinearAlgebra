...
class TransposedMatrixImpl
{
  public:
    ...
    TransposedMatrixImpl& operator-=(T const& summand)
    {
        ScalarSubstractAssignImpl<M, N, RawMatrix<M, N, T>, T>(matrix_, summand);
        return *this;
    }
    ...
    {
        MatrixAddAssignImpl<N, M, TransposedMatrixImpl<N, M, T>, MatrixType<N, M, OtherDerived, V>>(*this, right);
        return *this;
    }
    ...
    {
        MatrixAddAssignImpl<N, M, TransposedMatrixImpl<N, M, T>, TransposedMatrixImpl<N, M, V>>(*this, right);
        return *this;
    }
    ...
    TransposedMatrixImpl& operator/=(MatrixType<N, M, OtherDerived, V> const& right)
    {
        MatrixMemberDivideAssignImpl<N, M, TransposedMatrixImpl<N, M, T>, MatrixType<N, M, OtherDerived, V>>(*this,
                                                                                                             right);
        return *this;
    }
    ...
    TransposedMatrixImpl& operator/=(TransposedMatrixImpl<N, M, V> const& right)
    {
        MatrixMemberDivideAssignImpl<N, M, TransposedMatrixImpl<N, M, T>, TransposedMatrixImpl<N, M, V>>(*this, right);
        return *this;
    }
