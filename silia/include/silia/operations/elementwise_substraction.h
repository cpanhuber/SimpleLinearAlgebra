#ifndef SILIA__OPERATIONS__ELEMENTWISE_SUBSTRACTION_H
#define SILIA__OPERATIONS__ELEMENTWISE_SUBSTRACTION_H
...
#endif  // SILIA__OPERATIONS__ELEMENTWISE_SUBSTRACTION_H
