#ifndef SILIA__OPERATIONS__MULTIPLICATION_H
#define SILIA__OPERATIONS__MULTIPLICATION_H
...
{
    return detail::MultiplyImpl<I, J, 1, detail::MatrixType<I, J, MatrixTypeLeft, T>, Vector<J, T>, Vector<I, T>, T>(
        left, right);
}
