...
TEST(Substraction, Substraction_WhenMatrixMatrix)
{
...
TEST(Substraction, Substraction_WhenVectorMatrix)
{
...
TEST(Substraction, Substraction_WhenMatrixVector)
{
...
TEST(Substraction, Substraction_WhenTransposedViewLeft)
{
...
TEST(Substraction, Substraction_WhenTransposedViewRight)
{
    auto m1 = MakeMatrix({{5, 4}, {3, 2}});
    auto m2 = MakeMatrix({{0, 1}, {2, 3}});
...
TEST(Substraction, Substraction_WhenTransposedViewLeftVectorRight)
{
...
TEST(Substraction, Substraction_WhenTransposedViewRightVectorLeft)
{
