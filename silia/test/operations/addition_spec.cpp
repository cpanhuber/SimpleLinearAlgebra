...
TEST(Addition, Addition_WhenMatrixMatrix)
{
...
TEST(Addition, Addition_WhenVectorMatrix)
{
...
TEST(Addition, Addition_WhenMatrixVector)
{
...
TEST(Addition, Addition_WhenVectorVector)
{
...
TEST(Addition, Addition_WhenTransposedViewLeft)
{
...
TEST(Addition, Addition_WhenTransposedViewRight)
{
    auto m1 = MakeMatrix({{5, 4}, {3, 2}});
    auto m2 = MakeMatrix({{0, 1}, {2, 3}});
...
TEST(Addition, Addition_WhenTransposedViewLeftVectorRight)
{
...
TEST(Addition, Addition_WhenTransposedViewRightVectorLeft)
{
